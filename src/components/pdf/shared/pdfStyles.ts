...
export const s = StyleSheet.create({
  ...
  colProduct: { width: "22%", paddingHorizontal: 3, paddingVertical: 2 },
  colHS: { width: "12%", paddingHorizontal: 3, paddingVertical: 2 },
  colNW: { width: "13%", paddingHorizontal: 3, paddingVertical: 2, textAlign: "right" },
  colCtns: { width: "12%", paddingHorizontal: 3, paddingVertical: 2, textAlign: "right" },
  colQty: { width: "15%", paddingHorizontal: 3, paddingVertical: 2, textAlign: "right" },
  colPriceCtn: { width: "13%", paddingHorizontal: 3, paddingVertical: 2, textAlign: "right" },
  colTotal: { width: "13%", paddingHorizontal: 3, paddingVertical: 2, textAlign: "right" },
